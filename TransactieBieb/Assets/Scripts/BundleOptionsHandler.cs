...
public class BundleOptionsHandler : MonoBehaviour
{
    ...
    public void Init(Activity activityToLoad, ActivitySelection activitySelectionToLoad, bool isEdit)
    {
        ...
        title.text = loadedActivity.name;
        option.text = activitySelectionToLoad.selectedOptionName;
        ToggleFalse();
    ...
    public void ToggleFalse()
    {
        ...
        option.color = new Color(0, 0, 0, 0.4f);
    ...
    public void ToggleTrue()
    {
        ...
        option.color = new Color(0, 0, 0, 1f);
